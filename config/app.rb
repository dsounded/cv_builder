...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'cv-builder.com'
  config.app_name = 'Cv_builder'
  config.mailer.from = 'Cv_builder <no-reply@cv-builder.com>'
  ...
  #
  config.app_secret = 'gjOV7bSjChq029RhcCmJw_1KGVYXCUb82HEIDXx8o6dNydSPDhhVJ9cd0YrVmjfuPLc'
